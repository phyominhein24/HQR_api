...
enum PermissionEnum: string
{
    ...
    /** INVOICE */
    case ORDER_INDEX = 'Invoice_All';
    case ORDER_SHOW = 'Invoice_Detail';
    case ORDER_STORE = 'Invoice_Create';
    case ORDER_UPDATE = 'Invoice_Update';
    case ORDER_DESTROY = 'Invoice_Delete';

    /** INVOICE_ITEM */
    case ORDER_ITEM_INDEX = 'Invoice_Item_All';
    case ORDER_ITEM_SHOW = 'Invoice_Item_Detail';
    case ORDER_ITEM_STORE = 'Invoice_Item_Create';
    case ORDER_ITEM_UPDATE = 'Invoice_Item_Update';
    case ORDER_ITEM_DESTROY = 'Invoice_Item_Delete';
    ...
    /** ORDER */
    case INVOICE_INDEX = 'Order_All';
    case INVOICE_SHOW = 'Order_Detail';
    case INVOICE_STORE = 'Order_Create';
    case INVOICE_UPDATE = 'Order_Update';
    case INVOICE_DESTROY = 'Order_Delete';
    ...
    /** SACK */
    case SACK_INDEX = 'Sack_All';
    case SACK_SHOW = 'Sack_Detail';
    case SACK_STORE = 'Sack_Create';
    case SACK_UPDATE = 'Sack_Update';
    case SACK_DESTROY = 'Sack_Delete';

    /** SACK_DATA */
    case SACK_DATA_INDEX = 'Sack_Data_All';
    case SACK_DATA_SHOW = 'Sack_Data_Detail';
    case SACK_DATA_STORE = 'Sack_Data_Create';
    case SACK_DATA_UPDATE = 'Sack_Data_Update';
    case SACK_DATA_DESTROY = 'Sack_Data_Delete';

    /** SORTING */
    case SORTING_INDEX = 'Sorting_All';
    case SORTING_SHOW = 'Sorting_Detail';
    case SORTING_STORE = 'Sorting_Create';
    case SORTING_UPDATE = 'Sorting_Update';
    case SORTING_DESTROY = 'Sorting_Delete';

    /** INTEGRATION */
    case INTEGRATION_INDEX = 'Integration_All';
    case INTEGRATION_SHOW = 'Integration_Detail';
    case INTEGRATION_STORE = 'Integration_Create';
    case INTEGRATION_UPDATE = 'Integration_Update';
    case INTEGRATION_DESTROY = 'Integration_Delete';
